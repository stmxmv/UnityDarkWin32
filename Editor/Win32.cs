...
namespace AN
{
    static class Win32
    {
        ...
        public struct RECT
        {
            ...
            public void Pad(int l, int t, int r, int b)
            {
        ...
        {
            var deskWnd = GetDesktopWindow();

            GetWindowRect(window, out var a);
            a.Pad(WindowPadding, WindowPadding, WindowPadding, WindowPadding);
            GetWindowRect(GetDesktopWindow(), out var b);
        ...
        const uint WM_GETTEXT = 0x0000000D;
        const uint WM_GETTEXTLENGTH = 0x0000000E;
        ...
        //public static extern int SetWindowLong32(IntPtr hWnd, WindowLongFlags nIndex, int dwNewLong);

        [DllImport("user32.dll", EntryPoint="SetWindowLongPtr")]
        public static extern IntPtr SetWindowLong(IntPtr hWnd, WindowLongIndex nIndex, IntPtr dwNewLong);
        [DllImport("user32.dll", EntryPoint="GetWindowLongPtr")]
        public static extern IntPtr GetWindowLong(IntPtr hWnd, WindowLongIndex nIndex);

        //[DllImport("user32.dll")]
        //public static extern int SetWindowLong(IntPtr hWnd, WindowLongFlags nIndex, uint dwNewLong); 

        [DllImport("user32.dll")]
        public static extern WndProc SetWindowLong(IntPtr hWnd, WindowLongFlags nIndex, WndProc wndProc);
